export default class i18n {
  ...
  compare(str) {
    if (!(str instanceof i18n)) {
      str = new i18n(str)
    }
    return new i18n(this.#string).ascii().includes(str.ascii())
  }

  match_ascii() {
    let str = this.#string

    /* Stolen from https://github.com/backbone-paginator/backbone.paginator/blob/a579796a30e583c4dfa09e0a86e4abd21e0b5b56/plugins/diacritic.js
  ...
  ascii() {
    ...
    const defaultDiacriticsRemovalMap = [
      ...
      { base: 'TZ', letters: /[\uA728]/g },
      {
        base: 'U',
        letters:
          /[\u00DC\u0055\u24CA\uFF35\u00D9\u00DA\u00DB\u0168\u1E78\u016A\u1E7A\u016C\u01DB\u01D7\u01D5\u01D9\u1EE6\u016E\u0170\u01D3\u0214\u0216\u01AF\u1EEA\u1EE8\u1EEE\u1EEC\u1EF0\u1EE4\u1E72\u0172\u1E76\u1E74\u0244]/g,
      },
      {
        base: 'V',
        letters: /[\u0056\u24CB\uFF36\u1E7C\u1E7E\u01B2\uA75E\u0245]/g,
