...
export default class Kolor {
  ...
  constructor(color) {
    ...
    let ccolor = null;
    ccolor = Kolor.named2hex(color);
    if (ccolor === null) {
      ccolor = Kolor.hsl2hex(color);
      if (ccolor === null) {
        ccolor = Kolor.rgb2hex(color);
        if (ccolor === null) {
