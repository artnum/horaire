...
export default class Placement {
  ...
  static init() {
    ...
    Placement.#observer.observe(document.body, { childList: true, subtree: true, attributes: true, attributeFilter: ['style'] })
    window.addEventListener('resize', debounce(_ => { Placement.updatePlacement() }, 5), { capture: true })
    window.addEventListener('scroll', throttle(_ => { Placement.updatePlacement() }, 50), { capture: true })
  }
