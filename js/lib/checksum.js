/**
 * Use CRC32 to get a checksum.
 * For object and array, it sorts values in order to give the same results with the same content.
 * Sorting array and object is done by sorting their crc32.
 */
...
/* table is not above as in file preview only the top is seen and
 * const, if intialized, are hoisted
 */
const crcTable = [
