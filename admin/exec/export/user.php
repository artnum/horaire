...
try {
  ...
  $per_person = array();
  /* Entrées */
  $writer->writeSheetHeader('Entrées', array('Reference' => 'string', 'Projet'=> 'string', 'Process' => 'string', 'Repas' => 'string', 'Déplacement' => 'number', 'Description' => 'string', 'Jour' => 'datetime', 'Temps [h]' => '0.00', 'Temps noté [h]' => '0.00', 'Personne' => 'string'), array('widths'=>[10, 35, 25, 10, 10, 25]));
