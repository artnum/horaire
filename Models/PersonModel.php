...
class PersonModel extends artnum\SQL {
  ...
  function __construct($db, $config) {
    ...
    $this->set_req('get', 'SELECT 
      ...
      COALESCE("prixheure_value", 0.0) AS "person_price" FROM "\\Table" LEFT JOIN "prixheure" ON "prixheure_id" = (SELECT "prixheure_id" FROM "prixheure" WHERE "prixheure_person" = "person_id" AND DATE("prixheure_validity") <= DATE(NOW()) 
      ORDER BY "prixheure_validity" DESC, "prixheure_value" DESC LIMIT 1)');
  }
}
?>
